...
if(isset($_POST['insert']))
{
	...
	$gender=$_POST['Gender'];
	$mobilnum=$_POST['Mobile_Num'];
	$emailid=$_POST['Email_ID'];
	
	$sql=mysqli_query($con,"insert into admin(Name,Age,Address,Gender,Mobile_Num,Email_ID) values('$aname','$age','$address','$gender','$mobilnum','$emailid')");
if($sql)
{
