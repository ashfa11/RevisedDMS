...
<a href="insertAdmin.php"><button class="btn btn-primary"> Insert
Record</button></a>
<div class="table-responsive">
<table A_ID="mytable" class="table table-bordred table-striped">
<thead>
<th>#</th>
<th>A_ID</th>
<th>Name</th>
...
<td><a href="updateAdmin.php?A_ID=<?php echo
htmlentities($result['A_ID']);?>"><button class="btn btn-primary btnxs"><span class="glyphicon glyphicon-pencil"></span></button></a></td>
<td><button class="btn btn-danger"><a href="deleteAdmin.php?A_ID=<?php echo htmlentities($result['A_ID']);?>" class="text-light">Delete</a></button></td>
</tr>
<?php
